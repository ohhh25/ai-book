...
class Neural_Network:
    def __init__(self, n_inputs, n_hidden, n_outputs):    # n_hidden is the number of hidden neurons
        self.hidden_layer1 = Dense_Layer(n_inputs, n_hidden, regularization_lambda=0.001)
        self.activation1 = ReLU_Activation()
        self.hidden_layer2 = Dense_Layer(n_hidden, n_hidden, regularization_lambda=0.001)
        self.activation2 = ReLU_Activation()
        self.hidden_layer3 = Dense_Layer(n_hidden, n_hidden,  regularization_lambda=0.001)
        self.activation3 = ReLU_Activation()
        self.output_layer = Dense_Layer(n_hidden, n_outputs, regularization_lambda=0.001)
...
for i in range(400):
    ...
    regularization_penalty = get_regularization_penalty(model.trainable_layers, 0.001)
