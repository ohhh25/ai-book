...
class Neural_Network:
    ...
    def backward(self, y_true):
        ...
        self.drop3.backward(self.output_layer.dinputs)
        self.activation3.backward(self.drop3.dinputs)
        self.hidden_layer3.backward(self.activation3.dinputs)
        self.drop2.backward(self.hidden_layer3.dinputs)
        self.activation2.backward(self.drop2.dinputs)
        self.hidden_layer2.backward(self.activation2.dinputs)
        self.drop1.backward(self.hidden_layer2.dinputs)
        self.activation1.backward(self.drop1.dinputs)
